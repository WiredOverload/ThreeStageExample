...
export class Stage {
    ...
    constructor() {
        ...
        this.gameCamera = new OrthographicCamera(16 /  -2, 16 / 2, 9 / 2, 9 / -2, -1000, 1000);
        this.gameCamera.position.set(0, 0, 25);
        this.gameCamera.lookAt(0, 0, 0);

        this.UICamera = new OrthographicCamera(16 /  -2, 16 / 2, 9 / 2, 9 / -2, -1000, 1000);//make sure this is always the same as the gameCamera
